...
\begin{frame}[fragile]{Extra: Serial Devices in \texttt{/sys}}
  \begin{itemize}
    \item Serial devices appear under
      \texttt{/sys/class/tty/}
    \item Each entry links back to its driver and hardware
      \begin{verbatim}
/sys/class/tty/ttyS0/device
/sys/class/tty/ttyAMA0/device
      \end{verbatim}
    \item Which driver created a particular tty?
  \end{itemize}
\end{frame}
