...
\begin{frame}[fragile]{Exit Codes}
  \begin{itemize}
    \item Other languages use sophisticated exceptions, Result types
...
\begin{frame}{Locating Yourself in the Filesystem}
  \begin{itemize}
    \item Will be hugely emphasized in this class!
...
# You need to then explain to users.
...
# regular variable (will not get exported)
MYENV=hello
